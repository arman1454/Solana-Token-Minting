        ...
        <>
            <div className='lg:hidden pb-12 px-4 md:px-0'>
                ...
                <div className='text-[#cfcbbf] w-1/2'>
                    <h1 className='text-start pb-2 font-prata text-[22.5px]'>Token Generator</h1>
                    <p className='text-start font-raleway text-[18px]'>Use our Awesome Token Generator to Mint Your Own Tokens</p>
                </div>
                <div className='text-[#cfcbbf] w-1/2 translate-x-full'>
                    <h1 className='text-end pb-2 font-prata text-[22.5px]'>Get Airdrop</h1>
                    <p className='text-end font-raleway text-[18px]'>Use our Air Drop Feature to get instant Air Drop In Fase and Secured Way</p>
                </div>
                <div className='text-[#cfcbbf] w-1/2'>
                    <h1 className='text-start pb-2 font-prata text-[22.5px]'>Transfer Sol</h1>
                    <p className='text-start font-raleway text-[18px]'>Your can Transfer Your Sol To Any Account As Well As Donate Us</p>
                </div>
                <div className='text-[#cfcbbf] w-1/2 translate-x-full'>
                    <h1 className='text-end pb-2 font-prata text-[22.5px]'>Token Metadata</h1>
                    <p className='text-end font-raleway text-[18px]'>Fetch Your Generated Token's Metadata in fast and efficient way</p>
                </div>
        </div>
